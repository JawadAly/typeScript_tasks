let favPizzas:string[] = ["Pepperoni","Margherita","BBQ Chicken"];
for(let i = 0;i < favPizzas.length; i++){
    if(favPizzas[i] == "Pepperoni"){
        console.log(`I really like ${favPizzas[i]} Pizza`);
    }
    else if(favPizzas[i] == "Margherita"){
        console.log(`${favPizzas[i]} Pizza is one of my favourite!`);
    }
    else {
        console.log(`${favPizzas[i]} Pizza is one of the delicious spicy cuisine!`);
    }
}
